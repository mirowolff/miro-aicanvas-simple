      ...
      <div className="collaboration-bar-container">
        <div className="collaboration-bar">
          ...
          <div className="tools-section">
            {/* Facilitation Tools - custom wider button */}
            <button className="facilitation-tools-button" aria-label="Facilitation Tools">
            ...
            {/* Activity */}
            <IconButton aria-label="Activity" variant="ghost">
              <IconActivity />
            </IconButton>

            {/* Video Camera */}
            <IconButton aria-label="Video" variant="ghost">
              <IconVideoCameraSimple />
            </IconButton>
          </div>
